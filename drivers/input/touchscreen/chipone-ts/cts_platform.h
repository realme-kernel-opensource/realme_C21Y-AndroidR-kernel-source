...
struct cts_upgrade_fw_info {
	char module_vendor[20];
	char *firmware_path;
	const struct cts_firmware *fw_builtin;
	uint32_t fw_builtin_size;
};
extern struct cts_upgrade_fw_info cts_fw;

extern void cts_node_init(void);
#ifdef CONFIG_CTS_I2C_HOST
