...
static int __init himax_common_init(void)
{
	...
	if (!(strncmp(lcd_name,"lcd_hx83102d_truly_mipi_hd",strlen("lcd_hx83102d_truly_mipi_hd")))) {
		hx_ctpmodule = 0;
		I("This is lcd_hx83102d_truly_mipi_hd\n");
	} else if (!(strncmp(lcd_name,"lcd_hx83102d_truly_mipi_hd_temp",strlen("lcd_hx83102d_truly_mipi_hd_temp")))) {
		hx_ctpmodule = 0;
		I("This is lcd_hx83102d_truly_mipi_hd_temp\n");
	} else if (!(strncmp(lcd_name,"lcd_hx83102d_skyworth_mipi_hd",strlen("lcd_hx83102d_skyworth_mipi_hd")))) {
			hx_ctpmodule = 1;
