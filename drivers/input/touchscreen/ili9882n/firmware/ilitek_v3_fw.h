...
#define DEF_FW_SIGN_REQUEST_PATH "/vendor/firmware/tp/206A1/ILITEK_FW"
...
#define TXD_INI_NAME_PATH		"/vendor/firmware/mp_txd_ili7806s.ini"
#define TXD_FW_FILP_PATH		"/vendor/firmware/txd_ili7806s.bin"
#define TXD_INI_REQUEST_PATH	"mp_txd_ili7806s.ini"
#define TXD_FW_REQUEST_PATH		"txd_ili7806s.bin"
static unsigned char CTPM_FW_TXD[] = {
	#include "FW_TDDI_TXD_FB.ili"
};
...
#define LS_INI_NAME_PATH		"/vendor/firmware/tp/206A1/mp_ls.ini"
#define LS_FW_FILP_PATH         "/sdcard/ILITEK_FW_LS"
#define LS_INI_REQUEST_PATH		"/tp/206A1/mp_ls.ini"
#define LS_FW_REQUEST_PATH		"/tp/206A1/ls_ili9882n.bin"
#define LS_FW_SIGN_REQUEST_PATH "/tp/206A1/ls_ili9882n_oplus_signed.bin"
static unsigned char CTPM_FW_LS[] = {
	#include "FW_TDDI_LS_FB.ili"
};

#define TRULY_INI_NAME_PATH		"/vendor/firmware/tp/206A1/mp_truly.ini"
#define TRULY_FW_FILP_PATH         "/sdcard/ILITEK_FW_TRULY"
#define TRULY_INI_REQUEST_PATH		"/tp/206A1/mp_truly.ini"
#define TRULY_FW_REQUEST_PATH		"/tp/206A1/truly_ili9882n.bin"
#define TRULY_FW_SIGN_REQUEST_PATH "/tp/206A1/truly_ili9882n_oplus_signed.bin"
static unsigned char CTPM_FW_TRULY[] = {
	#include "FW_TDDI_TRULY_FB.ili"
};

#define SKY_INI_NAME_PATH		 "/vendor/firmware/mp_sky_ili9882q.ini"
#define SKY_FW_FILP_PATH         "/vendor/firmware/sky_ili9882q.bin"
#define SKY_INI_REQUEST_PATH	 "mp_sky_ili9882q.ini"
#define SKY_FW_REQUEST_PATH		 "sky_ili9882q.bin"
static unsigned char CTPM_FW_SKY[] = {
	#include "FW_TDDI_SKY_FB.ili"
};
#endif