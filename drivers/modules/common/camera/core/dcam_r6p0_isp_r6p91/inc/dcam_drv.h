...
#ifndef _DCAM_DRV_7731_H_
#define _DCAM_DRV_7731_H_
...
/* TODO: parse DT data func will put in dcam_drv.c derectly
...
#define DCAM_PATH_2_FRM_CNT_MAX                  32/*4*/
#define DCAM_PATH_0_FRM_CNT_MAX                  32
...
#define DCAM_MMU_IRQ_ERR_MASK	(DCAM_ISR_MMU_VAOR_WR |\
					DCAM_ISR_MMU_INV_WR |\
					DCAM_ISR_MMU_UNS_WR |\
					DCAM_ISR_MMU_PAOR_WR)

#define DCAM_IRQ_LINE_MASK	\
				(DCAM_ISR_SENSOR_EOF |\
				DCAM_ISR_CAP_SOF |\
				DCAM_ISR_CAP_EOF |\
				DCAM_ISR_CAM0_TX_DONE |\
				DCAM_ISR_CAM0_BUF_OVF |\
				DCAM_ISR_CAM1_TX_DONE |\
				DCAM_ISR_CAM1_BUF_OVF |\
				DCAM_ISR_CAM2_TX_DONE |\
				DCAM_ISR_CAM2_BUF_OVF |\
				DCAM_ISR_LINE_ERR |\
				DCAM_ISR_FRM_ERR |\
				DCAM_ISR_ISP_OVF |\
				DCAM_ISR_MIPI_OVF |\
				DCAM_ISR_ROT_DONE |\
				DCAM_ISR_PDAF_TX_DONE |\
				DCAM_ISR_PATH0_SOF |\
				DCAM_ISR_PATH1_SOF |\
				DCAM_ISR_PATH2_SOF |\
				DCAM_MMU_IRQ_ERR_MASK)

#define DCAM_IRQ_ERR_MASK		(DCAM_ISR_CAM0_BUF_OVF |\
					DCAM_ISR_CAM1_BUF_OVF |\
					DCAM_ISR_CAM2_BUF_OVF |\
					DCAM_ISR_LINE_ERR |\
					DCAM_ISR_FRM_ERR |\
...
#define PATH0_IRQ_LINE_MASK		(DCAM_ISR_CAM0_TX_DONE |\
					DCAM_ISR_CAM0_BUF_OVF |\
					DCAM_ISR_PATH0_SOF)

#define PATH1_IRQ_LINE_MASK		(DCAM_ISR_CAM1_TX_DONE |\
					DCAM_ISR_CAM1_BUF_OVF |\
					DCAM_ISR_PATH1_SOF)

#define PATH2_IRQ_LINE_MASK		(DCAM_ISR_CAM2_TX_DONE |\
					DCAM_ISR_CAM2_BUF_OVF |\
					DCAM_ISR_PATH2_SOF)

#define SCALER_IRQ_LINE_MASK		PATH2_IRQ_LINE_MASK

#define ROTATION_IRQ_LINE_MASK		DCAM_ISR_ROT_DONE
...
enum {
	...
	DATA_TYPE_YUV422_8BIT = 0x1e
};

enum {
	MATCH_BY_VC = 0x0,
	MATCH_BY_DATA_TYPE = 0x1
};

#define PIKE2_DCAM_RAWRGB 0x2
#define MATCH_TYPE_SET_BIT (BIT_0 | BIT_1)
#define MATCH_TYPE_OFFSET 0
#define DATA_TYPE_SET_BIT 0x3F00
