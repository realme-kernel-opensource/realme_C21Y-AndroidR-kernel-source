...
#define REG_ROTATION_PATH_CFG (ROT_BASE + 0x0120UL)
#define REG_ROTATION_ORIGWIDTH (ROT_BASE + 0x0124UL)
#define REG_ROTATION_OFFSET_START (ROT_BASE + 0x0128UL)
#define REG_ROTATION_IMG_SIZE (ROT_BASE + 0x012CUL)
