...
#ifndef __SHARKL5PRO_MM_DVFS_REG_H____
#define __SHARKL5PRO_MM_DVFS_REG_H____
...
//#define BIT_DCAM_AXI_AUTO_TUNE_EN       (BIT(7))
...
#define SHIFT_CPP_DFS_EN                (2)
#define BIT_ISP_DFS_EN                  (BIT(1))
#define BIT_MM_MTX_DVFS_SW_EN           (BIT(0))

#define SHIFT_BIT_DCAM_AXI_AUTO_TUNE_EN       (7)
#define SHIFT_BIT_FD_DFS_EN                   (6)
#define SHIFT_BIT_DCAM_IF_DFS_EN              (5)
#define SHIFT_BIT_JPG_DFS_EN                  (3)
#define SHIFT_BIT_CPP_DFS_EN                  (2)
#define SHIFT_BIT_ISP_DFS_EN                  (1)
#define SHIFT_BIT_MM_MTX_DVFS_SW_EN           (0)
...
#define SHIFT_BIT_FD_DFS_SW_TRIG             (6)
#define SHIFT_BIT_DCAM_DFS_SW_TRIG           (5)
#define SHIFT_BIT_JPG_DFS_SW_TRIG            (3)
#define SHIFT_BIT_CPP_DFS_SW_TRIG            (2)
#define SHIFT_BIT_ISP_DFS_SW_TRIG            (1)
...
#define SHIFT_BIT_REG_DCAM_IF_FREQ_UPD_EN_BYP  (5)
#define SHIFT_BIT_REG_JPG_FREQ_UPD_EN_BYP      (4)
#define SHIFT_BIT_REG_CPP_FREQ_UPD_EN_BYP      (3)
#define SHIFT_BIT_REG_ISP_FREQ_UPD_EN_BYP      (2)
#define SHIFT_BIT_REG_MM_MTX_FREQ_UPD_EN_BYP   (1)
#define SHIFT_BIT_REG_DCAM_AXI_FREQ_UPD_EN_BYP (0)
...
#define BITS_CGM_DCAM_IF_FDIV_DENOM_DVFS(_X_) ((_X_) << 17 & \
	(BIT(17)|BIT(18)|BIT(19)|BIT(20)))
#define BITS_CGM_DCAM_IF_FDIV_NUM_DVFS(_X_) ((_X_) << 13 & \
...
#endif /* __SHARKL5PRO_MM_DVFS_H____ */
