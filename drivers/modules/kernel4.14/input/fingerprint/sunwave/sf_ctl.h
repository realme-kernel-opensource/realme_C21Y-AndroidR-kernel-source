...
/* Note: 1-SP9832 0-SP9850 */
#define SPRD_PLATFORM_CONFIG        0

#define SUPPLY_POWER_BY_REGULATOR    0
#define SUPPLY_POWER_BY_GPIO         0
...
struct sf_key_event_t {
	enum sf_key_type_t key;
...
#define SF_IOC_REPORT_KEY_EVENT _IOW(SF_IOC_MAGIC, 0x09, struct sf_key_event_t *)
