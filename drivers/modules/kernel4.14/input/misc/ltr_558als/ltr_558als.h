...
/* ----------------------------- */
#define LTR558_ALS_INTEG_MEAS_RATE_REG          0x85

#define LTR558_ALS_INTEG_TIME__POS          3
#define LTR558_ALS_INTEG_TIME__LEN          3
#define LTR558_ALS_INTEG_TIME__MSK          0x38
#define LTR558_ALS_INTEG_TIME__REG          LTR558_ALS_INTEG_MEAS_RATE_REG

#define LTR558_ALS_MEAS_RATE__POS          0
#define LTR558_ALS_MEAS_RATE__LEN          3
#define LTR558_ALS_MEAS_RATE__MSK          0x07
#define LTR558_ALS_MEAS_RATE__REG          LTR558_ALS_INTEG_MEAS_RATE_REG

/* bitname not include post,eg: LTR558_ALS_MEAS_RATE  */
#define LTR558_GET_BITSLICE(regvar, bitname)\
	((regvar & bitname##__MSK) >> bitname##__POS)
/* regvar is read from reg, val is set only corresponding bits, return new data */
#define LTR558_SET_BITSLICE(regvar, bitname, val)\
