...
static struct device_attribute dev_attr_write_reg = {
		.attr = {
			.name = "write_reg",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = NULL,
		.store = write_firmware_register_store,
};
...
static struct device_attribute dev_attr_read_reg = {
		.attr = {
			.name = "read_reg",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = read_firmware_register_show,
		.store = read_firmware_register_store,
};
...
static struct device_attribute dev_attr_read_hw_reg = {
		.attr = {
			.name = "read_hw_reg",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = read_hw_reg_show,
		.store = read_hw_reg_store,
};
...
static struct device_attribute dev_attr_write_hw_reg = {
		.attr = {
			.name = "write_hw_reg",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = NULL,
		.store = write_hw_reg_store,
};
...
static struct device_attribute dev_attr_curr_version = {
		.attr = {
			.name = "curr_version",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = curr_firmware_version_show,
		.store = NULL,
};
...
static struct device_attribute dev_attr_curr_ddi_version = {
		.attr = {
			.name = "curr_ddi_version",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = curr_ddi_version_show,
		.store = NULL,
};
...
static struct device_attribute dev_attr_rows = {
		.attr = {
			.name = "rows",
			.mode = S_IWUSR | S_IRUGO,
		},
...
static struct device_attribute dev_attr_cols = {
		.attr = {
			.name = "cols",
			.mode = S_IWUSR | S_IRUGO,
		},
...
static struct device_attribute dev_attr_res_x = {
		.attr = {
			.name = "res_x",
			.mode = S_IWUSR | S_IRUGO,
		},
...
static struct device_attribute dev_attr_res_y = {
		.attr = {
			.name = "res_y",
			.mode = S_IWUSR | S_IRUGO,
		},
...
static struct device_attribute dev_attr_esd_protection = {
		.attr = {
			.name = "esd_protection",
			.mode = S_IWUSR | S_IRUGO,
		},
...
static struct device_attribute dev_attr_monitor_mode = {
		.attr = {
			.name = "monitor_mode",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = monitor_mode_show,
		.store = monitor_mode_store,
};
...
static struct device_attribute dev_attr_auto_compensate = {
		.attr = {
			.name = "auto_compensate",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = auto_compensate_show,
		.store = NULL,
};
...
static struct device_attribute dev_attr_driver_builtin_firmware = {
		.attr = {
			.name = "driver_builtin_firmware",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = driver_builtin_firmware_show,
		.store = driver_builtin_firmware_store,
};
...
static struct device_attribute dev_attr_update_from_file = {
		.attr = {
			.name = "update_from_file",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = NULL,
		.store = update_firmware_from_file_store,
};
...
static struct device_attribute dev_attr_updating = {
		.attr = {
			.name = "updating",
			.mode = S_IWUSR | S_IRUGO,
		},
...
static struct device_attribute dev_attr_info = {
		.attr = {
			.name = "info",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = flash_info_show,
		.store = NULL,
};
...
static struct device_attribute dev_attr_read = {
		.attr = {
			.name = "read",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = read_flash_show,
		.store = read_flash_store,
};
...
static struct device_attribute dev_attr_erase = {
		.attr = {
			.name = "erase",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = NULL,
		.store = erase_flash_store,
};
...
static struct device_attribute dev_attr_open_test = {
		.attr = {
			.name = "open_test",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = open_test_show,
		.store = open_test_store,
};
...
static struct device_attribute dev_attr_short_test = {
		.attr = {
			.name = "short_test",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = short_test_show,
		.store = short_test_store,
};
...
static struct device_attribute dev_attr_testing = {
		.attr = {
			.name = "testing",
			.mode = S_IWUSR | S_IRUGO,
		},
...
static struct device_attribute dev_attr_reset_test = {
		.attr = {
			.name = "reset_test",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = reset_test_show,
		.store = NULL,
};
...
static struct device_attribute dev_attr_compensate_cap_test = {
		.attr = {
			.name = "compensate_cap_test",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = compensate_cap_test_show,
		.store = compensate_cap_test_store,
};
...
static struct device_attribute dev_attr_rawdata_test = {
		.attr = {
			.name = "rawdata_test",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = rawdata_test_show,
		.store = rawdata_test_store,
};
...
static struct device_attribute dev_attr_ic_type = {
		.attr = {
			.name = "ic_type",
			.mode = S_IWUSR | S_IRUGO,
		},
...
static struct device_attribute dev_attr_program_mode = {
		.attr = {
			.name = "program_mode",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = program_mode_show,
		.store = program_mode_store,
};
...
static struct device_attribute dev_attr_rawdata = {
		.attr = {
			.name = "rawdata",
			.mode = S_IWUSR | S_IRUGO,
		},
...
static struct device_attribute dev_attr_diffdata = {
		.attr = {
			.name = "diffdata",
			.mode = S_IWUSR | S_IRUGO,
		},
...
static struct device_attribute dev_attr_manualdiff = {
		.attr = {
			.name = "manualdiff",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = manualdiffdata_show,
		.store = manualdiffdata_store,
};
...
static struct device_attribute dev_attr_jitter = {
		.attr = {
			.name = "jitter",
			.mode = S_IWUSR | S_IRUGO,
		},
...
static struct device_attribute dev_attr_compensate_cap = {
		.attr = {
			.name = "compensate_cap",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = compensate_cap_show,
		.store = NULL,
};
...
static struct device_attribute dev_attr_reset_pin = {
		.attr = {
			.name = "reset_pin",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = reset_pin_show,
		.store = reset_pin_store,
};
...
static struct device_attribute dev_attr_irq_pin = {
		.attr = {
			.name = "irq_pin",
			.mode = S_IWUSR | S_IRUGO,
		},
...
static struct device_attribute dev_attr_irq_info = {
		.attr = {
			.name = "irq_info",
			.mode = S_IWUSR | S_IRUGO,
		},
...
static struct device_attribute dev_attr_fw_log_redirect = {
		.attr = {
			.name = "fw_log_redirect",
			.mode = S_IWUSR | S_IRUGO,
		},
		.show = fw_log_redirect_show,
		.store = fw_log_redirect_store,
};
...
{
	struct chipone_ts_data *pdata = dev_get_drvdata(dev);
